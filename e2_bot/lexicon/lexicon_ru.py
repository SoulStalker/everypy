...
LEXICON: dict[str, str] = {
    ...
    'funny_exists': '⚠️ Такая фигня уже существует!',
    'all_closed': '<i>Все смены закрыты</i>',
    'select_menu': '📋 Выбери команду из меню\nИли просто пришли стикер или гифку — я не против 😉',
    'select_type': '🔽 Выберите тип данных для работы:',
    'funny_saved': '✅ Готово! Файл сохранён 🗂️',
    'unknown_message': '🤔 <b>Неизвестное сообщение</b>',
}
